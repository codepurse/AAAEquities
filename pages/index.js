    ...
    <>
      ...
      <div className="container h-100">
        <div className="row h-100 align-items-center">
          ...
          <div className="col-lg-6 colRight">
            <img
              src="Image/Phone.png"
              className="img-fluid imgRight mx-auto d-flex animate__faster"
            ></img>
            <p className="pForm pForm1">
              When <b>resistance</b> levels are broken, a breakout may occur.
              Buy breakouts automatically with Conditional Orders.
            </p>
            <p className="pForm pForm2">
              When <b>support</b> levels are broken, a breakout may occur. Set
              automatic stops with Conditional orders to protect your capital.
            </p>
            <p className="pForm pForm7">
              <b>Margin</b> increases your buying power by borrowing funds. To
              use margin, upgrade your account to a AAA Turbo Margin Account.
            </p>
          </div>
        </div>
      </div>
